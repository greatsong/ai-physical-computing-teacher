...
- DHT20 ~7,900원 / 빛센서 ~5,200원 / SSD1306 OLED 0.96" ~3,000원
- SCD30 CO2 ~65,000원 / AHT20+BMP280 콤보 ~3,500원
- 심박센서(Pulse) ~21,000원 / MAX30102 SpO2+심박 ~1,700원
- 초음파 ~4,900원 / 부저 ~2,100원 / LED Bar ~5,700원
- Grove 아날로그 마이크(MEMS) ~8,800원 / MPU6050 ~3,500원
- DHT11 ~1,300원 / GP2Y10 먼지센서 ~7,000원 / DS18B20 방수 ~3,500원
...
- MQ-135 ~1,500원 / 토양수분 ~3,800원 / TDS ~17,000원 / PH ~12,800원
- I2C LCD ~2,500원 / SH1106 OLED ~11,400원 / MAX7219 ~2,200원
- TM1637 ~1,200원 / WS2813 RGB LED Stick ~5,500원 / e-Paper ~31,600원
...
- PS2 조이스틱 ~1,500원 / 슬라이드 포텐셔미터 ~1,200원
- NEO-6M GPS ~5,500원 / 로드셀+HX711 ~5,500원
- 전류센서(ACS70331) ~12,000원 / 공압센서(XGZP6847A) ~5,000원
